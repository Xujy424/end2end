...
class GRU_Model(nn.Module):
    ...
    def forward(self, x):
        dx = th.cat([x['dailyset1'],x['dailyset2']], dim=-1)
        dh, _ = self.gru(dx)
        dh = dh[:, -1, :]
    ...
    def get_default_config(self):
        ...
        return {
                ...
                "dataset": {
                    ...
                    'params':{
                        "shared_param_dict" : {
                            ...
                            "fix_stock": None,
                            "sample_size": None,
                            "nanflit_set": ['dailyset1','dailyset2']
                        },
                        "specified_param_dict" :{
                            ...
                            'dailyset2': {
                                'data_path': '/data/xujiayi/xjy/research_factors/model_input/ered_v2/ffill/',
            ...
            "model": {
                "name": 'gru',
                "params":{
                    "input_size": len(self.d_fields)+len(self.f_fields),
                    "hidden_size": 128,
                    "num_layers": 4,
                    "dropout": 0.5,
                },
