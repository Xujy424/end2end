...
from .utils.EncDec import Decoder, DecoderLayer, Encoder, EncoderLayer
from .utils.Attn import FullAttention, AttentionLayer
...
class Transformer(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec, attn_mask=None):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        dec_out = self.forecast(
            x_enc, x_mark_enc, x_dec, x_mark_dec, attn_mask=mask
        )
